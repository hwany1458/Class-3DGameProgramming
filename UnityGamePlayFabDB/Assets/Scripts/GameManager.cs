...
public class GameManager : MonoBehaviour
{
    ...
    public int storedArmor;
    public int storedPlayingTime;
    public int storedGunItem;
    ...
    public void GetUserData(string myPlayFabId)
    {
        ...
        result => {
            ...
            else { Debug.Log("Department is " + result.Data["Department"].Value); }
        }, 
        error => {
    ...
    public void GetUserData1(string myPlayFabId)
    {
        ...
        GetUserData1Success, GetUserData1Failure
        );
    }
